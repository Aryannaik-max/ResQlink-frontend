        ...
        <div className='flex h-[100%] space-x-10'>
          <div className='rounded-2xl w-[20%] mt-10 flex flex-col shadow-black shadow-2xl bg-white'>
            <div className='flex items-center text-center  py-4 px-4'>
              ...
              <a href='/dashboard' className='text-gray-900 hover:text-blue-600 ml-2 text-sm'> My Profile</a>
            </div>
            <div className='flex items-center text-center py-4 px-4'>
              <img src={serviceProvider} alt='Service Provider Icon' className='w-7 mb-1' />
              <a href='/service-registration' className='text-gray-900 hover:text-blue-600 ml-2 text-sm'>Register as service provider</a>
            </div>
            <div className='flex items-center p-4'>
              <img src={history} alt='History Icon' className='w-7 mb-1' />
              <a href='/history' className='text-gray-900 hover:text-blue-600 ml-2 text-sm'>History</a>
            </div>
            <div className='flex items-center p-4'>
              <img src={driver} alt='History Icon' className='w-7 mb-1' />
              <a href='/crew' className='text-gray-900 hover:text-blue-600 ml-2 text-sm'>Crew</a>
            </div>
          </div>
          <div className='flex flex-col rounded-2xl  flex-grow items-center justify-center mt-10 text-center p-6 shadow-black shadow-2xl'>
            ...
            <button className='bg-blue-600 text-white px-12 py-4 rounded-lg text-2xl font-bold hover:bg-blue-700 transition-colors duration-200'>Report Emergency</button>
          </div>
        </div>
      </div>
    </div>
