...
const UserSignup = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen bg-gradient-to-tl from-gray-700 to-gray-900'>
          <div className='border-2 bg-white  w-[25%] h-[72%] rounded-2xl flex  items-center flex-col p-5 pb-20 shadow-black shadow-2xl'>
            ...
            <div>
                ...
                <div className='flex w-full flex-col items-center '>
                  ...
                  <p className='mt-2 text-sm text-gray-600 space-x-'>
